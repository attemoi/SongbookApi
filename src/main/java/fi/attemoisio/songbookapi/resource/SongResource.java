...
public class SongResource {
	...
	public SongResource(UriInfo uriInfo, SongRepository songRepository, String bookId) {
	...
	public Response addSong(
		...
		if (songRepository.addSong(bookId, song)) {
			return Response.created(getCreatedUri(bookId)).entity(song)
					.build();
		} else {
	...
	public Response deleteSong(
		...
		if (songRepository.deleteSong(bookId, songId)) {
			...
			throw new NotFoundException(
					"Could not delete song (id not found).");
		}
